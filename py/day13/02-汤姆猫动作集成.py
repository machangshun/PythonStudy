...
class TomCat(object):
    ...
    def initImages(self,flag):
        ...
        if flag == "cymbal":
            for i in range(0, 13):
                list.append("Animations/Cymbal/cymbal_%02d.jpg" % i)
        elif flag == "drink":
            for i in range(0, 81):
                list.append("Animations/Drink/drink_%02d.jpg" % i)
        elif flag == "eat":
            for i in range(0,40):
                list.append("Animations/Eat/eat_%02d.jpg" % i)
        elif flag == "fart":
            for i in range(0, 28):
                list.append("Animations/Fart/fart_%02d.jpg" % i)
        elif flag == "pie":
            for i in range(0, 24):
                list.append("Animations/Pie/pie_%02d.jpg" % i)
        elif flag == "scratch":
            for i in range(0, 56):
                list.append("Animations/Scratch/scratch_%02d.jpg" % i)
        elif flag == "knockout":
            for i in range(0,81):
                list.append("Animations/Knockout/knockout_%02d.jpg" % i)
        elif flag == "stomach":
            for i in range(0,34):
                list.append("Animations/Stomach/stomach_%02d.jpg" % i)
        elif flag == "footright":
            for i in range(0,30):
                list.append("Animations/FootRight/footRight_%02d.jpg" % i)
        elif flag == "footleft":
            for i in range(0,30):
                list.append("Animations/FootLeft/footLeft_%02d.jpg" % i)
        elif flag == "angry":
            for i in range(0,26):
                list.append("Animations/Angry/angry_%02d.jpg" % i)
        #返回
        return list
